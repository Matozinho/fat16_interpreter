...
bool compare_fat_bs(const interpreter::Fat16::fat_BS& a, const interpreter::Fat16::fat_BS& b) {
  fmt::print("bytes_per_sector: {} == {} ? {}\n", a.bytes_per_sector, b.bytes_per_sector,
             a.bytes_per_sector == b.bytes_per_sector);
  fmt::print("sectors_per_cluster: {} == {} ? {}\n", a.sectors_per_cluster, b.sectors_per_cluster,
             a.sectors_per_cluster == b.sectors_per_cluster);
...
TEST(Fat16, ReadBootRecord_4SectorsPerCluster) {
  ...
  interpreter::Fat16::fat_BS boot_record_4sectors;
  // {
  //     {0x90, 0x3c, 0xeb},                                               // bootjmp
  //     {0x6d, 0x6b, 0x66, 0x73, 0x2e, 0x66, 0x61, 0x74},                 // oem_name
  //     static_cast<unsigned char>(static_cast<unsigned short>(0x0200)),  // bytes_per_sector
  //     0x04,                                                             // sectors_per_cluster
  //     0x0004,                                                           // reserved_sectors
  //     0x02,                                                             // fat_count
  //     static_cast<unsigned char>(static_cast<unsigned short>(0x0200)),  // root_entry_count
  //     static_cast<unsigned char>(static_cast<unsigned short>(0xA000)),  // total_sectors_16
  //     0xf8,                                                             // media_type
...
TEST(Fat16, ReadBootRecord_1SectorsPerCluster) {
  ...
  interpreter::Fat16::fat_BS boot_record_4sectors = {
      ...
      0x02,                                                             // fat_count
      static_cast<unsigned char>(static_cast<unsigned short>(0x0200)),  // root_entry_count
      static_cast<unsigned char>(static_cast<unsigned short>(0x9c40)),
      0xf8,        // media_type
